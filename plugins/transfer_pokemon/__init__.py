...
class TransferPokemon(Plugin):
    ...
    def filter_pokemon_by_ignore_list(self, bot, transfer_list=None, filter_list=None):
        ...
        for pokemon in transfer_list:
            ...
            self.log(always_keep_list[species_name]);
            if species_name not in always_keep_list or isinstance(always_keep_list[species_name], list) and "keep" in always_keep_list[species_name] and always_keep_list[species_name]["keep"] is False:
